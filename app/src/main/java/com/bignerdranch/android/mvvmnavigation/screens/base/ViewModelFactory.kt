...
import com.bignerdranch.android.mvvmnavigation.navigator.ARG_SCREEN
...
class ViewModelFactory(
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        // Провайдер,это специальный класс с помощью которого можно получить доступ к навигатору из вью модел фэктори
